...
```sh
opencode plugin @opencode-cockpit/shell@0.6.0 --global --force     # OpenCode 1
opencode plugin add @opencode-cockpit/shell@0.6.0                   # OpenCode 2
```
...
{
  "plugins": [
    { "package": "opencode-cockpit@0.6.0", "options": { "features": { "shell": true } } }
  ]
}
```
