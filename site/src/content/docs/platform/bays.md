...
```sh
opencode plugin @opencode-cockpit/status@0.5.0 --global --force
```
...
```sh
opencode plugin @opencode-cockpit/review@0.5.0 --global --force
```
...
```sh
opencode plugin @opencode-cockpit/updater@0.5.0 --global --force
```
