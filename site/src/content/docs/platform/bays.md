...
```sh
opencode plugin @opencode-cockpit/shell@0.7.0 --global --force
```
...
```sh
opencode plugin @opencode-cockpit/review@0.7.0 --global --force
```
...
```sh
opencode plugin @opencode-cockpit/updater@0.7.0 --global --force
```
