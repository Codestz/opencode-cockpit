...
export const hero = {
  ...
  install: "opencode plugin opencode-cockpit@0.5.2 --global --force",
}
  ...
  modes: [
    {
      id: "all",
      label: "Everything",
      command: "opencode plugin opencode-cockpit@0.5.2 --global --force",
      note:
    ...
    },
    {
      id: "one",
      label: "Shell only",
      command: "opencode plugin @opencode-cockpit/shell@0.5.2 --global --force",
      note:
